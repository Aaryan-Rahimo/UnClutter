...
function EmailDetail({ email, onBack, onDelete, onArchive, onStar, onReply, onForward, onToggleRead }) {
    ...
    <div className="email-detail">
      <div className="email-detail__toolbar">
        ...
        <button
          ...
          title="Forward"
        >
          <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M12 8V4l8 8-8 8v-4H4v-8z"/></svg>
          Forward
        </button>
        <button
          type="button"
